...
(function ($) {
        ...
        if (isSingleElimination) {
            ...
            if (teams.length > 1 && !opts.skipConsolationRound) {
                ...
                Consol1.setAlignCb(function (tC) {
                    ...
                    tC.css("top", topShift + "px"); //aqui he tocado
                });
        ...
        var finalMatch = round.addMatch(function () { return [
            ...
            if (!opts.skipSecondaryFinal &&
                ...
                match21.setAlignCb(function (tC) {
                    // var height = winners.el.height() + losers.el.height(); //aqui
                    var height = "130";
    ...
    var Round = /** @class */ (function () {
        function RoundA(bracket, previousRound, roundNumber, 
            ...
            this.roundCon = $("<div class=\"round flex-item\" style=\"width: " + this.containerWidth + "px\"/>");
            this.matches = [];
        }
    ...
    var JqueryBracket = function (opts) {
        ...
        var topCon = $('<div class="jQBracket flex-container ' + opts.dir + '"></div>').appendTo(opts.el.empty());
