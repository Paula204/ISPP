...
describe('Service Tests', () => {
    describe('PaypalCompletedPayments Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PaypalCompletedPayments', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        date: currentDate.format(DATE_TIME_FORMAT)
            ...
            it('should update a PaypalCompletedPayments', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_TIME_FORMAT),
                        idPayment: 'BBBBBB',
            ...
            it('should return a list of PaypalCompletedPayments', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_TIME_FORMAT),
                        idPayment: 'BBBBBB',
            ...
            it('should delete a PaypalCompletedPayments', async () => {
