...
public class UserAccountResourceIntTest {
     ...
     *
     * @see com.ispp.thorneo.repository.search.UserAccountSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final UserAccountResource userAccountResource = new UserAccountResource(userAccountRepository, mockUserAccountSearchRepository);
    ...
    public void createUserAccount() throws Exception {
        ...
        assertThat(testUserAccount.getUserName()).isEqualTo(DEFAULT_USER_NAME);
        assertThat(testUserAccount.getPassword()).isEqualTo(DEFAULT_PASSWORD);
        assertThat(testUserAccount.isBanned()).isEqualTo(DEFAULT_BANNED);
    ...
    public void updateUserAccount() throws Exception {
        ...
        UserAccount testUserAccount = userAccountList.get(userAccountList.size() - 1);
        assertThat(testUserAccount.getUserName()).isEqualTo(UPDATED_USER_NAME);
        assertThat(testUserAccount.getPassword()).isEqualTo(UPDATED_PASSWORD);
        assertThat(testUserAccount.isBanned()).isEqualTo(UPDATED_BANNED);
